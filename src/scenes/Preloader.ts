...
export class Preloader extends Scene {
    ...
    preload() {
        ...
        // iPadOS 13+ defaults Safari/Chrome to a desktop ("Macintosh") user-agent, so Phaser's UA-based
        // device.os.iOS/iPad come back false and a new iPad gets the desktop layout. A real Mac has no
        // touch; a "Mac" reporting touch points is an iPad — correct the flags here before anything reads
        // them (so every iOS/iPad/!desktop branch fires, incl. the mobile-atlas + tablet layout).
