...
export class NewGameConfirmScene extends BaseMenuScene {
    ...
    private createBody(): void {
        const line1 = translate(
            this.cardCount === 1 ? LanguageConfig.ConfirmNewGameBody1 : LanguageConfig.ConfirmNewGameBody3
        );
    ...
    private handleSleep(): void {
        ...
        // treat it as a cancel so the toggle visual gets reverted.
        if (this.resolved) return;
        this.resolved = true;
        const cb = this.onCancel;
        cb();
