...
// edge-pinned, their tops aligned with the stock/foundation row). Applies to all iPads in landscape,
// plus FULLSCREEN Android tablets in landscape — an Android UA WITHOUT "Mobile" is a tablet, not a
// phone. Kept separate from isTablet() so we don't disturb the fullscreen-forcing (isTablet() must stay
// false for Android tablets or the game stops forcing them fullscreen).
